...
Router::get('mesas', [App\Controllers\AtendimentosController::class, 'listarMesas'])->name('mesas.list');

// Abrir ou recuperar atendimento de uma mesa pelo ID
Router::get('mesa/{id}/atendimento', [App\Controllers\AtendimentosController::class, 'atendimentoId'])->name('mesa.atendimento');

// Listar todos os atendimentos
Router::get('atendimentos', [App\Controllers\AtendimentosController::class, 'index'])->name('atendimentos');
...
// Deletar pedido
Router::post('pedido/delete', [App\Controllers\AtendimentosController::class, 'delete'])->name('pedido.delete');
